                ...
                <div class="grid gap-x-[30px] gap-y-10 sm:grid-cols-2 lg:grid-cols-3">
                    <div v-for="item in jsonData" :key="item?.id">
                        <div data-aos="fade-up" data-aos-duration="1000">
                            ...
                            >
                                <router-link :to="`/blog-details/${item?.id}`" class="absolute top-0 h-full w-full ltr:left-0 rtl:right-0"></router-link>
                                <img :src="item?.image" alt="blog" class="h-52 w-full rounded-t-3xl object-cover" />
                                <div class="p-5 text-sm font-bold">
                                    <h6 class="font-extrabold text-secondary dark:text-secondary">{{item?.category}}</h6>
