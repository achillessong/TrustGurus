                ...
                <div class="container">
                    <div class="items-center py-10 md:flex md:h-[400px] md:py-0">
                        <div class="heading relative mb-0 md:w-[725px]">
                            <h4 class="!text-white">Analytics and tooling for LLMs</h4>
                            <p
                            ...
                            >
                                Flowstack.ai is a website that offers LLM (Language Model Monitoring) analytics, monitoring, and observability tools. It provides developers, product managers, customer success teams, QA and security teams, sales and marketing professionals, as well as operations and finance teams with valuable insights and data to enhance their decision-making and optimize their processes.
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <section class="py-14 md:py-[100px]">
            <div class="container">
                ...
                <div class="pb-14 md:pb-20">
                    ...
                    >
                    Flowstack.ai offers features like usage monitoring to track and analyze usage, requests, tokens, and cache, as well as cost analytics to understand the costs associated with users, requests, and models.
                    </p>
                    <p
                    ...
                    >
                    It also provides LLM optimization capabilities, allowing users to easily add remote cache, rate limits, and auto retries to their applications.
                    </p>
                </div>
                <div>
                    <img src="/src/portfolioes/ai-2.png" alt="portfolio-img-4" class="rounded-[32px]" data-aos="fade-up" data-aos-duration="1000" />
                </div>
            </div>
        </section>
