                ...
                <div class="container">
                    <div class="items-center py-10 md:flex md:h-[400px] md:py-0">
                        <div class="heading relative mb-0 md:w-[725px]">
                            <h4 class="!text-white">Lisk is Evolving</h4>
                            <p
                            ...
                            >
                            Lisk is an open-source blockchain platform written in JavaScript that allows users to develop, deploy and run decentralized applications.
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <section class="py-14 md:py-[100px]">
            <div class="container">
                <div>
                    ...
                    <div class="overflow-x-auto overflow-y-hidden">
                        <ul class="flex w-[520px] justify-between gap-4 md:w-auto md:justify-start md:gap-7" data-aos="fade-up" data-aos-duration="1000">
                            ...
                            >
                                <div>
                                    <img src="/public/src/skills/typeform.svg" alt="typeform" class="h-10 w-10 rounded-r-[32px] rounded-l-[32px] object-cover md:rounded-r-none" />
                                </div>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="pb-14 md:pb-20">
                    ...
                    >
                    The Lisk community participates in discussions on Discord, Lisk Magazine blog posts, and forums dedicated to development and research.
                    </p>
                    <p
                    ...
                    >
                    Lisk's research and development operations are based out of their Center in Berlin, Germany, housed by the Onchain Foundation which also oversees the Lisk protocol.
                    </p>
                    <p
                        class="relative mt-5 font-semibold leading-[30px] before:absolute before:top-0 before:h-full before:w-1 before:rounded before:bg-primary ltr:pl-6 ltr:before:left-0 rtl:pr-6 rtl:before:right-0 md:text-lg"
                    >
                    In addition to supporting Web3 adoption, Lisk also partners with organizations like Unstoppable Domains to further blockchain innovation.
                    </p>
                </div>
                <div class="py-[30px] sm:py-[50px]">
                    <img src="/src/portfolioes/block-3.png" alt="portfolio-img-3" class="rounded-[32px]" data-aos="fade-up" data-aos-duration="1000" />
                </div>
            </div>
        </section>
