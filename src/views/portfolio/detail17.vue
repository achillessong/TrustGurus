                ...
                <div class="container">
                    <div class="items-center py-10 md:flex md:h-[400px] md:py-0">
                        <div class="heading relative mb-0 md:w-[725px]">
                            <h4 class="!text-white">Suisse-View</h4>
                            <p
        ...
        <section class="py-14 md:py-[100px]">
            <div class="container">
                <div>
                    ...
                    <div class="overflow-x-auto overflow-y-hidden">
                        <ul class="flex w-[520px] justify-between gap-4 md:w-auto md:justify-start md:gap-7" data-aos="fade-up" data-aos-duration="1000">
                            ...
                            >
                                <div>
                                    <img src="/public/src/skills/google-analytics.svg" alt="google anylytics" class="h-10 w-10 rounded-r-[32px] rounded-l-[32px] object-cover md:rounded-r-none" />
                                </div>
                            </li>
                            <li
                                class="flex h-16 w-16 items-center justify-center rounded-2xl border border-transparent bg-white transition duration-500 hover:border-secondary hover:bg-secondary/20 dark:bg-gray-dark md:h-20 md:w-20 md:rounded-[32px]"
                ...
                <div class="pb-14 md:pb-20">
                    ...
                    >
                    They offer professional virtual tours, images and videos for showcasing real estate properties, events, tourist attractions and other venues/spaces.
                    </p>
                    <p
                    ...
                    >
                    Their services can help clients around the world experience and explore places in Switzerland virtually through interactive tours on their website.
                    </p>
                </div>
                <div class="py-[30px] sm:py-[50px]">
                    <img src="/src/portfolioes/em-6.png" alt="portfolio-img-3" class="rounded-[32px]" data-aos="fade-up" data-aos-duration="1000" />
                </div>
            </div>
        </section>
