                ...
                <div class="container">
                    <div class="items-center py-10 md:flex md:h-[400px] md:py-0">
                        <div class="heading relative mb-0 md:w-[725px]">
                            <h4 class="!text-white">Konaequity</h4>
                            <p
                            ...
                            >
                            Kona Equity is a private company intelligence platform that provides information on millions of small and medium-sized businesses.
                            </p>
                            <p
                                class="relative mt-7 font-medium text-[#BBC0D0] before:absolute before:top-0 before:h-full before:w-1 before:bg-primary ltr:pl-8 ltr:before:left-0 rtl:pr-8 rtl:before:right-0"
                            >
                            It focuses on key industries like computer software, construction, automotive, manufacturing, healthcare and financial services.
                            </p>
                            <p
                                class="relative mt-7 font-medium text-[#BBC0D0] before:absolute before:top-0 before:h-full before:w-1 before:bg-primary ltr:pl-8 ltr:before:left-0 rtl:pr-8 rtl:before:right-0"
                            >
                            Users can explore companies through category browse pages or search functions with features like smart keyword searches.
                            </p>
        ...
        <section class="py-14 md:py-[100px]">
            <div class="container">
                <div>
                    ...
                    <div class="overflow-x-auto overflow-y-hidden">
                        <ul class="flex w-[520px] justify-between gap-4 md:w-auto md:justify-start md:gap-7" data-aos="fade-up" data-aos-duration="1000">
                            ...
                            >
                                <div>
                                    <img src="/public/src/skills/icons8-django-96.png" alt="django" class="h-10 w-10 rounded-r-[32px] rounded-l-[32px] object-cover md:rounded-r-none" />
                                </div>
                            </li>
                            <li
                                class="flex h-16 w-16 items-center justify-center rounded-2xl border border-transparent bg-white transition duration-500 hover:border-secondary hover:bg-secondary/20 dark:bg-gray-dark md:h-20 md:w-20 md:rounded-[32px]"
                            >
                                <div>
                                    <img src="/public/src/skills/icons8-python-96.png" alt="python" class="h-10 w-10 rounded-r-[32px] rounded-l-[32px] object-cover md:rounded-r-none" />
                                </div>
                            </li>
                            <li
                                class="flex h-16 w-16 items-center justify-center rounded-2xl border border-transparent bg-white transition duration-500 hover:border-secondary hover:bg-secondary/20 dark:bg-gray-dark md:h-20 md:w-20 md:rounded-[32px]"
                            >
                                <div>
                                    <img src="/public/src/skills/icons8-glide-loading-images-in-apps-and-web-pages-96.png" alt="glide" class="h-10 w-10 rounded-r-[32px] rounded-l-[32px] object-cover md:rounded-r-none" />
                                </div>
                            </li>
                            <li
                                class="flex h-16 w-16 items-center justify-center rounded-2xl border border-transparent bg-white transition duration-500 hover:border-secondary hover:bg-secondary/20 dark:bg-gray-dark md:h-20 md:w-20 md:rounded-[32px]"
                ...
                <div class="pb-14 md:pb-20">
                    ...
                    >
                    Kona Equity aims to be the leading provider of intelligence on the backbone small businesses that drive the private economy.
                    </p>
                </div>
                <div class="py-[30px] sm:py-[50px]">
                    <img src="/src/portfolioes/em-5.png" alt="portfolio-img-3" class="rounded-[32px]" data-aos="fade-up" data-aos-duration="1000" />
                </div>
            </div>
        </section>
