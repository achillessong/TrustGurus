...
<script setup lang="ts">
    ...
    onMounted(async () => {
    try {
        const leadersResponse = await fetch('../src/json/detail-blockchain.json');
        const stepProcessesResponse = await fetch('../src/json/stepProcessBlockChain.json');
        const expertiseResponse = await fetch('../src/json/expertiseBlockChain.json');
