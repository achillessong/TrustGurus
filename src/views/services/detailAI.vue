...
<script setup lang="ts">
    ...
    onMounted(async () => {
    try {
        const leadersResponse = await fetch('/json/detail-ai.json');
        const stepProcessesResponse = await fetch('/json/stepProcessAI.json');
        const expertiseResponse = await fetch('/json/expertiseAI.json');
