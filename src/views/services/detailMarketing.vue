...
<script setup lang="ts">
    ...
    onMounted(async () => {
    try {
        const leadersResponse = await fetch('/json/detail-degital.json');
        const stepProcessesResponse = await fetch('/json/stepProcessDigital.json');
        const expertiseResponse = await fetch('/json/expertiseDegital.json');
