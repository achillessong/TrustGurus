<template>
    <div class="container">
        <div class="heading text-center">
            <h6 :class="{ hidden: !showTitle }">{{jsonData[4]?.description}}</h6>
            <h4>{{jsonData[5]?.description}}</h4>
        </div>
                ...
                >
                    ...
                    <div class="ltr:pl-4 rtl:pr-4">
                        <count-up
                            ...
                            :startVal="0"
                            :end-val="jsonData[0]?.description ? jsonData[0].description : 0"
                            :duration="20"
                            :options="{ suffix: '+' }"
                        ></count-up>
                ...
                >
                    ...
                    <div class="ltr:pl-4 rtl:pr-4">
                        <count-up
                            class="pb-2.5 text-4xl font-black leading-none transition dark:text-white dark:group-hover:text-black"
                            :startVal="0"
                            :end-val="jsonData[1]?.description ? jsonData[1].description : 0"
                            :duration="10"
                            :options="{ suffix: '+' }"
                        ></count-up>
                ...
                >
                    ...
                    <div class="ltr:pl-4 rtl:pr-4">
                        <count-up
                            class="pb-2.5 text-4xl font-black leading-none transition dark:text-white dark:group-hover:text-black"
                            :startVal="0"
                            :end-val="jsonData[2]?.description ? jsonData[2].description : 0"
                            :duration="10"
                            :options="{ suffix: '+' }"
                        ></count-up>
                ...
                >
                    ...
                    <div class="ltr:pl-4 rtl:pr-4">
                        <count-up
                            class="pb-2.5 text-4xl font-black leading-none transition dark:text-white dark:group-hover:text-black"
                            :startVal="0"
                            :end-val="jsonData[3]?.description ? jsonData[3].description : 0"
                            :duration="10"
                            :options="{ suffix: '+' }"
                        ></count-up>
