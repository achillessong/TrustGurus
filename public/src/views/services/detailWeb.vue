            ...
            <div class="container lg:pt-7">
                <div class="relative">
                    <div class="pt-14 pb-8 text-center text-white lg:w-3/5 lg:py-20 ltr:lg:text-left rtl:lg:text-right">
                        ...
                        <p class="my-8 text-lg lg:w-3/4">TrustGurus is fully equipped with everything you need to build a high performing website for your SaaS.</p>
...
<script setup lang="ts">
    ...
    onMounted(async () => {
    try {
        const leadersResponse = await fetch('./public/json/detail-web.json');
