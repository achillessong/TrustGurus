                ...
                <div class="container">
                    <div class="items-center py-10 md:flex md:h-[400px] md:py-0">
                        <div class="heading relative mb-0 md:w-[725px]">
                            <h4 class="!text-white">Arcade Studio</h4>
                            <p
                            ...
                            >
                            Arcade.Studio is a website that offers a creation engine for everyone. It provides a platform where users can access various tools, products, and services to bring their creative ideas to life. The website emphasizes privacy and protection of user information, as outlined in their Global Privacy Policy.
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <section class="py-14 md:py-[100px]">
            <div class="container">
                ...
                <div class="pb-14 md:pb-20">
                    ...
                    >
                    The platform offers different features, including Alpha/Beta Agreement for testing and providing feedback on Arcade Studio's proprietary web applications.
                    </p>
                    <p
                    ...
                    >
                    Arcade Studio grants limited use rights to beta customers, allowing them to access and test the functionality of the Beta Products. 
                    </p>
                    <p
                        class="relative mt-5 font-semibold leading-[30px] before:absolute before:top-0 before:h-full before:w-1 before:rounded before:bg-primary ltr:pl-6 ltr:before:left-0 rtl:pr-6 rtl:before:right-0 md:text-lg"
                    >
                    Feedback is encouraged, and beta customers are expected to provide suggestions, enhancement requests, and recommendations to Arcade Studio. 
                    </p>
                    <p
                        class="relative mt-5 font-semibold leading-[30px] before:absolute before:top-0 before:h-full before:w-1 before:rounded before:bg-primary ltr:pl-6 ltr:before:left-0 rtl:pr-6 rtl:before:right-0 md:text-lg"
                    >
                    The intellectual property rights of Arcade Studio, including patents, copyrights, trademarks, and trade secrets, are retained by the company.
                    </p>
                    
                </div>
                <div>
                    <img src="/src/portfolioes/de-2.png" alt="portfolio-img-4" class="rounded-[32px]" data-aos="fade-up" data-aos-duration="1000" />
                </div>
            </div>
        </section>
