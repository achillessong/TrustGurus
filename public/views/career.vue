<template>
    <div>
                ...
                <div class="container">
                    <div class="items-center justify-between py-10 md:flex md:h-[400px] md:py-0">
                        <div class="heading relative mb-0 text-center ltr:md:text-left rtl:md:text-right">
                            <h6>Career</h6>
                            <h4 class="!text-white">Join our team at <span class="text-primary">{{store.teamname}}</span></h4>
                        </div>
        ...
        <section class="bg-gradient-to-t from-white/[54%] to-transparent py-14 dark:bg-none lg:py-[100px]">
            <div class="container">
                <div class="heading text-center">
                    <h6>{{jsonData[1]?.subtitle}}</h6>
                    <h4>{{jsonData[1]?.title}}</h4>
                </div>
                ...
                <div class="grid gap-[30px] sm:grid-cols-2 lg:grid-cols-3">
                    <div data-aos="fade-up" data-aos-duration="1000">
                        ...
                        >
                            ...
                            <h6 class="text-xl font-bold text-black dark:text-white">{{jsonData[2]?.perk1}}</h6>
                        </div>
                    </div>
                    <div data-aos="fade-up" data-aos-duration="1000">
                        <div
                        ...
                        >
                            ...
                            <h6 class="text-xl font-bold text-black dark:text-white">{{jsonData[2]?.perk2}}</h6>
                        </div>
                    </div>
                    <div data-aos="fade-up" data-aos-duration="1000">
                        <div
                        ...
                        >
                            ...
                            <h6 class="text-xl font-bold text-black dark:text-white">{{jsonData[2]?.perk3}}</h6>
                        </div>
                    </div>
                    <div data-aos="fade-up" data-aos-duration="1000">
                        <div
                        ...
                        >
                            ...
                            <h6 class="text-xl font-bold text-black dark:text-white">{{jsonData[2]?.perk4}}</h6>
                        </div>
                    </div>
                    <div data-aos="fade-up" data-aos-duration="1000">
                        <div
                        ...
                        >
                            ...
                            <h6 class="text-xl font-bold text-black dark:text-white">{{jsonData[2]?.perk5}}</h6>
                        </div>
                    </div>
                    <div data-aos="fade-up" data-aos-duration="1000">
                        <div
                        ...
                        >
                            ...
                            <h6 class="text-xl font-bold text-black dark:text-white">{{jsonData[2]?.perk6}}</h6>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="py-14 lg:py-[100px]" id="open-position">
            <div class="container">
                <div class="heading text-center">
                    <h6>{{jsonData[3]?.subtitle}}</h6>
                    <h4>{{jsonData[3]?.title}}</h4>
                </div>
                <div class="pb-[50px]">
                    <ul
                    ...
                    >
                        <div v-for="positionType in positionTypes">
                            <li class="filter" :class="{ active: activeTab === positionType?.tab }">
                                <button
                                    type="button"
                                    class="rounded-[10px] bg-gray/5 py-4 px-3 leading-5 transition hover:bg-secondary hover:text-white"
                                    @click="activeTab = positionType?.tab"
                                >
                ...
                <div class="projects grid gap-[30px] md:grid-cols-2">
                    <template v-for="position in positions">
                        <div class="project" :class="activeTab === 'all' || activeTab === position?.tab ? 'block' : 'hidden'">
                            <div
                            ...
                            >
                                <h6 class="mb-5 text-base font-black uppercase text-secondary dark:group-hover:text-black">{{position?.subtitle}}</h6>
                                <h4 class="mb-10 text-xl font-extrabold text-black dark:text-white sm:text-2xl">{{position?.description}}</h4>
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div class="font-bold text-black dark:text-white sm:text-lg">
                                            {{position?.location}} - <span class="text-primary">{{position?.type}}</span>
                                        </div>
                                    </div>
                                    <a
                                        href="javascript:"
...
<script setup lang="ts">
    ...
    onMounted(async () => {
    try {
        const response = await fetch('./src/json/careers.json');
        const positionTypesResponse = await fetch('./src/json/positionTypes.json');
        const positinResponse = await fetch('./src/json/positions.json');
